    ...
    return (
        <div className={""}>
            ...
            <header>
                ...
                <nav
                    className="font-sans flex flex-col text-center sm:flex-row sm:text-left sm:justify-between py-2 px-6 bg-indigo-100 shadow-sm sm:items-baseline w-full">
                    ...
                    <div className={"mb-2 sm:mb-0"}>
                        <div className="flex space-x-4">
                            ...
                            {/* TODO: Now working */}
                            <span
                                className="text-gray-500 hover:text-gray-700 px-3 py-2 rounded-sm">Team (Now working)</span>
                            <Link
                                href="/about"
                                className="text-gray-500 hover:text-gray-700 px-3 py-2 rounded-sm">
                                About
                            </Link>
                        </div>
                    </div>
            ...
            <footer id="footer" className={"w-full h-12 flex justify-center items-center border-t"}>
                <span className={"text-indigo-700 hover:text-indigo-700 px-5 py-2 rounded-sm"}>
                    &copy; 2022 BMS - Baseball Management System
                </span>
                <Link
                    href="mailto:bms-dev@googlegroups.com"
                    className={"text-indigo-300 hover:text-indigo-700 px-5 py-2 rounded-sm"}>
                    お問い合わせ
                </Link>
                {/*
                <Link href="https://twitter.com/BmsStatus">
                    <a className={"text-indigo-300 hover:text-indigo-700 px-5 py-2 rounded-sm"}>Twitter</a>
                </Link>
                */}
            </footer>
        </div>
